...
with st.sidebar:
    ...
    st.markdown("Enter your custom keys below to override environment defaults securely.")
    
    provider = st.selectbox("Select Provider", ["Gemini", "OpenAI", "Claude"])
    
    # Secure Inputs for Individual Providers
...
# Resolve Active Keys (Sidebar takes priority, falls back to environment/secrets)
