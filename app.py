            ...
            try:
                if provider == "Gemini":
                    ...
                    if response.function_calls:
                        ...
                        draft_prompt = f"The brief is finalized: {json.dumps(args)}. Now write the full content draft based on these specs, and ask the user for any corrections or suggestions."
                    ...
                    if response_message.tool_calls:
                        ...
                        formatted_messages.append({"role": "user", "content": "Now write the full content draft based on these specs, and ask the user for any corrections or suggestions."})
